  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#05070a] text-gray-400">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-20">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(28rem,34rem)] lg:gap-16">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-[minmax(0,1fr)_auto] lg:gap-12">
            ...
            {/* Footer Columns */}
            <div className="grid grid-cols-2 gap-8 sm:min-w-72">
